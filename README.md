...
- Creator photos: add `img/creators/01.jpg` to `06.jpg` and they appear with a print treatment (grayscale, multiplied into the section blue, halftone on top). Any missing file falls back to the numeral tile.
